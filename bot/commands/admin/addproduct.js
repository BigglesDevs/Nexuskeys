...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("addproduct")
    .setDescription("[ADMIN] Add a new product")
  ...
  async execute(interaction) {
    ...
    return interaction.editReply({
      embeds: [new EmbedBuilder().setColor(0x22c55e).setTitle("✅ Product Created")
        .setDescription(`**${product.name}** added. Use \`/addvariant\` to add pricing plans.`)],
    });
  },
};
